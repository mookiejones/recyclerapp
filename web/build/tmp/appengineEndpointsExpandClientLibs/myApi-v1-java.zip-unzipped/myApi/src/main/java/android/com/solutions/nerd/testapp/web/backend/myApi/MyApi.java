 ...
 * on 2015-11-12 at 15:46:52 UTC 
 * Modify at your own risk.
 */

package android.com.solutions.nerd.testapp.web.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://AIzaSyAErHCGTPXpMDIWHG2tLlo7pVOa.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "getAis".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetAis#execute()} method to invoke the remote operation.
   *
   * @param location
   * @return the request
   */
  public GetAis getAis(java.lang.String location) throws java.io.IOException {
    GetAis result = new GetAis(location);
    initialize(result);
    return result;
  }

  public class GetAis extends MyApiRequest<android.com.solutions.nerd.testapp.web.backend.myApi.model.AisBoat> {

    private static final String REST_PATH = "aisboat/{location}";

    /**
     * Create a request for the method "getAis".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link GetAis#execute()} method to invoke the remote operation. <p> {@link
     * GetAis#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param location
     * @since 1.13
     */
    protected GetAis(java.lang.String location) {
      super(MyApi.this, "GET", REST_PATH, null, android.com.solutions.nerd.testapp.web.backend.myApi.model.AisBoat.class);
    ...
    @Override
    public GetAis setAlt(java.lang.String alt) {
      return (GetAis) super.setAlt(alt);
    }

    @Override
    public GetAis setFields(java.lang.String fields) {
      return (GetAis) super.setFields(fields);
    }

    @Override
    public GetAis setKey(java.lang.String key) {
      return (GetAis) super.setKey(key);
    }

    @Override
    public GetAis setOauthToken(java.lang.String oauthToken) {
      return (GetAis) super.setOauthToken(oauthToken);
    }

    @Override
    public GetAis setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetAis) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetAis setQuotaUser(java.lang.String quotaUser) {
      return (GetAis) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetAis setUserIp(java.lang.String userIp) {
      return (GetAis) super.setUserIp(userIp);
    }
    ...
    public GetAis setLocation(java.lang.String location) {
      this.location = location;
      return this;
    }

    @Override
    public GetAis set(String parameterName, Object value) {
      return (GetAis) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<android.com.solutions.nerd.testapp.web.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, android.com.solutions.nerd.testapp.web.backend.myApi.model.MyBean.class);
